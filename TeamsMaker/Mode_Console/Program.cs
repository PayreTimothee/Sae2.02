...
namespace TeamsMaker
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            nomfichier = parseur.Parser("DonjonClassique_100.jt");
            ...
            Console.WriteLine();
            Console.WriteLine($"Nombre de Personnages sans équipe : {repartir.PersonnagesSansEquipe.Count()}"); //utilie pour les niveaux 2 et 3 ou il y a des personnages sans équipe quand on manque de roles
